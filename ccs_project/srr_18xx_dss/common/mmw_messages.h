...
/*It was working fine on MSS without linking the stdint, now it must be included.
 * Undefined behaviour to be solved later
 * Time is precious and I don't have time :(
 * Try to recompile after changing "mmw_messages.h" to <mmw_messages.h>
 * */
#include <stdint.h>
