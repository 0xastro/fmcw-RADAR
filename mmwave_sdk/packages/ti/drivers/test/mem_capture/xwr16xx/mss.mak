...
vpath %.c $(MMWAVE_SDK_INSTALL_PATH)/ti/drivers/test/mem_capture/xwr16xx
...
mssTest: buildDirectories mmWaveFullRTSC $(MSS_MEMORY_CAPTURE_UNIT_TEST_OBJECTS)
	...
	@echo '******************************************************************************'
	@echo 'Built the XWR16xx Memory Capture '
	@echo '******************************************************************************'
...
###################################################################################
mssTestClean:
	@echo 'Cleaning the XWR16xx Memory Capture objects'
	...
	@echo 'Cleaning the XWR16xx Memory Capture RTSC package'
