...
mssTest: buildDirectories mmWaveFullRTSC $(MSS_MEMORY_CAPTURE_UNIT_TEST_OBJECTS)
	...
	@echo '******************************************************************************'
	@echo 'Built the $(MMWAVE_SDK_DEVICE_TYPE) MSS Memory Capture '
	@echo '******************************************************************************'
...
###################################################################################
mssTestClean:
	@echo 'Cleaning the $(MMWAVE_SDK_DEVICE_TYPE) MSS Memory Capture objects'
	...
	@echo 'Cleaning the $(MMWAVE_SDK_DEVICE_TYPE) MSS Memory Capture RTSC package'
